...
from svndae import ssh
from svndae.test.util import mkdir, maketemp, writeFile, readFile
...
class GenerateAuthorizedKeys_Test(object):
  def test_simple(self):
    ...
    eq(gen.next(), (
       'command="svndae-filter jdoe",no-port-forwarding,no-X11-f'
       +'orwarding,no-agent-forwarding,no-pty %s' % KEY_1))
    eq(gen.next(), (
       'command="svndae-filter wsmith",no-port-forwarding,no-X11'
...
''' % dict(key_1=KEY_1)
  ...
  def test_filter_autogeneratedComment_backwardsCompat(self):
    got = self.run('### autogenerated by svndae, DO NOT EDIT\n')
    eq(got, '')
  ...
  def test_filter_simple(self):
    s = '''\
command="svndae-filter wsmith",no-port-forwarding,no-X11-forwardin\
g,no-agent-forwarding,no-pty %(key_1)s
''' % dict(key_1=KEY_1)
    got = self.run(s)
    eq(got, '')
  ...
  def test_filter_withPath(self):
    s = '''\
command="/foo/bar/baz/svndae-filter wsmith",no-port-forwarding,no-X11-forwardin\
g,no-agent-forwarding,no-pty %(key_1)s
''' % dict(key_1=KEY_1)
    got = self.run(s)
    eq(got, '')
...
# foo
bar
### autogenerated by svndae, DO NOT EDIT
command="/foo/bar/baz/svndae-filter wsmith",no-port-forwarding,\
...
baz
### autogenerated by svndae, DO NOT EDIT
command="svndae-filter jdoe",no-port-forwarding,\
